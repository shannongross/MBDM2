...
def get_model_for_problem_formulation(problem_formulation_id):
    ...
    # 8-objectives PF:
        ...
        outcomes.append(ScalarOutcome('GelderlandUpstream Expected Annual Damage', variable_name=['{}_Expected Annual Damage'.format(dike)
                                         for dike in function.dikelist[0:len(function.dikelist)-3]], function=sum_over, kind=direction))
                                                                              
        outcomes.append(ScalarOutcome('GelderlandDownstream Expected Annual Damage', variable_name=['{}_Expected Annual Damage'.format(dike)
                                         for dike in function.dikelist[2:len(function.dikelist)-1]], function=sum_over, kind=direction))
